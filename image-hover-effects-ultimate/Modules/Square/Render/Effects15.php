...
class Effects15 extends Public_Render {
    ...
    public function default_render( $style, $child, $admin ) {
        ...
        foreach ( $child as $key => $val ) {
            ...
            ?>
            <div class="oxi-image-hover-style oxi-image-hover-style-15-square <?php $this->column_render( 'oxi-image-hover-col', $style ); ?>
            <?php
            if ( $admin == 'admin' ) :
                                ...
                                <div class="oxi-image-hover-figure-caption">
                                    <div class="oxi-image-hover-caption-tab <?php echo esc_attr( $this->style['oxi-image-hover-content-alignment'] ); ?>">
                                        ...
                                        if ( $value['image_hover_heading'] != '' ) :
                                            ?>
                                            <div class="oxi-image-hover-figure-heading <?php echo esc_attr( $this->style['oxi-image-hover-heading-animation'] ); ?> <?php echo esc_attr( $this->style['oxi-image-hover-heading-animation-delay'] ); ?>"><h3 class="oxi-image-hover-heading 
                                            <?php
