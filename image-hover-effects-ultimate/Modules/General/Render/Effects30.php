...
class Effects30 extends Public_Render {
    ...
    public function default_render( $style, $child, $admin ) {
        ...
        foreach ( $child as $key => $val ) {
            ...
            $ht = '';
            ?>
            <div class="oxi-image-hover-style oxi-image-hover-style-30 oxi-image-general-hover-style-30-<?php echo esc_attr( $this->oxiid ); ?> <?php $this->column_render( 'oxi-image-hover-col', $style ); ?>
            <?php
            if ( $admin == 'admin' ) :
