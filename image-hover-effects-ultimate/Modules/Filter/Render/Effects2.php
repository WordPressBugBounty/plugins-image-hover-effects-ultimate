        ...
        <div class="image-hover-filter-style image-hover-filter-style-2">
            <div class="image-hover-category-menu image-hover-category-menu-<?php echo (int) $oxiid; ?>">
                ...
                foreach ( $all_cat_data as $value ) :
                    ?>
                <div class="image-hover-category-menu-item <?php echo esc_attr( $styledata['category_menu_width_type'] ); ?>
					<?php
					...
					?>
						...
						foreach ( $select_cat_data as $item ) :
							...
							echo ' ';
								endforeach;
						?>
                                    <?php echo esc_attr( $childdata['category_item_col-lap'] . '-lap' ); ?> <?php echo esc_attr( $childdata['category_item_col-tab'] . '-tab' ); ?> <?php echo esc_attr( $childdata['category_item_col-mob'] . '-mob' ); ?>
                                    <?php
									if ( $admin == 'admin' ) :
