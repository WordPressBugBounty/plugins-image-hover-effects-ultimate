...
trait Sanitization {
    ...
    public function oxilab_flip_box_admin_col_data( $id, $value, $name, $title ) {
        ...
        <div class="form-group row form-group-sm">
            ...
            <div class="col-sm-6">
                <select class="form-control" id="<?php echo esc_attr( $id ); ?>" name="<?php echo esc_attr( $id ); ?>">
                    <option value="oxilab-flip-box-col-1" 
                    <?php
					...
					?>
                    >Single Item</option>
                    <option value="oxilab-flip-box-col-2" 
                    <?php
					...
					?>
                    >2 Items</option>
                    <option value="oxilab-flip-box-col-3" 
                    <?php
					...
					?>
                    >3 Items</option>
                    <option value="oxilab-flip-box-col-4" 
                    <?php
					...
					?>
                    >4 Items</option>
                    <option value="oxilab-flip-box-col-5" 
                    <?php
					...
					?>
                    >5 Items</option>
                    <option value="oxilab-flip-box-col-6" 
                    <?php
        ...
        <div class="form-group row form-group-sm">
            ...
            <div class="col-sm-3">
                <select class="form-control" id="<?php echo esc_attr( $border_type ); ?>" name="<?php echo esc_attr( $border_type ); ?>">
					...
					?>
                    >Custom 1</option>
                    <option value="dotted solid dashed" 
                    <?php
					...
					?>
                    >Custom 2</option>
                    <option value="dotted solid dashed double" 
                    <?php
        ...
        <div class="form-group row form-group-sm">
            ...
            <div class="col-sm-6">
                <select class="form-control" id="oxilab-flip-type" name="oxilab-flip-type">
                    <option value="oxilab-flip-box-flip oxilab-flip-box-flip-top-to-bottom" 
                    <?php
                    ...
                    <option value="oxilab-flip-box-flip oxilab-flip-box-flip-left-to-right" 
                    <?php
                    ...
                    <option value="oxilab-flip-box-flip oxilab-flip-box-flip-bottom-to-top" 
                    <?php
                    ...
                    <option value="oxilab-flip-box-flip oxilab-flip-box-flip-right-to-left" 
                    <?php
        ...
        <div class="form-group row form-group-sm">
            ...
            <div class="col-sm-6">
                <select class="form-control" id="oxilab-flip-effects" name="oxilab-flip-effects">
                    <option value="easing_easeInOutExpo" 
                    <?php
                    ...
                    <option value="easing_easeInOutCirc" 
                    <?php
                    ...
                    <option value="easing_easeOutBack" 
                    <?php
